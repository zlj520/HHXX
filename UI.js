...
ui.layout(
    <drawer id="drawer">
        <vertical>
            <appbar>
                <toolbar id="toolbar" bg="#ff4fb3ff" title="腾讯游戏"/>
                        ...
                        <vertical gravity="center" layout_weight="1">
                            <card w="*" h="70" margin="10 5" cardCornerRadius="2dp" cardElevation="1dp" foreground="?selectableItemBackground">
                                <horizontal gravity="center_vertical">
                                    ...
                                    <spinner id="script_chosen" marginLeft="4" marginRight="6" entries="腾讯游戏Pro" />
                                </horizontal>
                            </card>
                            <card w="*" h="70" margin="10 5" cardCornerRadius="2dp" cardElevation="1dp" foreground="?selectableItemBackground">
                                <horizontal gravity="center_vertical">
...
ui.emitter.on("options_item_selected", (e, item) => {
    switch (item.getTitle()) {
        case "日志":
            ...
            break;
        case "关于":
            alert("关于", "腾讯游戏 v" + latest_version);
            break;
    }
    e.consumed = true;
});
...
ui.start.click(function () {
    ...
    threads.start(function () {
        execution = engines.execScript("腾讯游戏", getScript(ui.script_chosen.getSelectedItemPosition()));
    });
});
...
function getScript(choice) {
    let url_prefix = [
	    'https://v.sec-an-cf.top/gh/raw/zlj520/HHXX/main/',
